...
public class Activity2 {
	...
	public static void selectOptions () {
		...
		int choice = Checker.inputChecker("Select: ",1,7);
		System.out.println("");
		switch ( choice ) {
			case 1:
			fileIO = new FileIO();
			...
			case 2:
				if (tableList.isEmpty()) {
					...
					row = Checker.inputChecker("Enter row index: ", 0, maxRowIndex);
					maxColIndex = tableList.get(row).size() - 1;
					column = Checker.inputChecker("Enter column index: ", 0, maxColIndex);
			...
			case 3:
				if (tableList.isEmpty()) {
					...
					String textPattern = Checker.searchInputChecker();
			...
			case 5:
				if (tableList.isEmpty()) {
					...
					row = Checker.inputChecker("Enter row you want to sort: ",0,tableList.size() - 1);
			...
			case 6:
				...
				row = Checker.inputChecker(0,"Enter the number of row: ");
				column = Checker.inputChecker(0,"Enter the number of column: ");
