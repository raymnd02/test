...
public class Activity2 {
	...
	public static void main(String[] args) {
		try {
			InputStream is = Activity2.class.getClassLoader().getResourceAsStream("profileProperty.properties");
			Properties p = new Properties();
			p.load(is);
			String name = p.getProperty("message");
			System.out.println("\n\n===================================================");
		...
		file = dir + "\\app\\src\\main\\resources\\Sample.txt";
		selectOptions();
	...
	public static void selectOptions () {
		...
		ArrayList<ArrayList<Table>> tableList = fileIO.read(file);
